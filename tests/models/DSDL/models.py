...
class DSDLResnet(nn.Module):
    def __init__(self, model, num_classes, alpha, in_channel=300):
        super(DSDLResnet, self).__init__()
        self.alpha = alpha
...
class DSDL(DSDLResnet):
    def __init__(self, num_classes, alpha, pretrained=True, in_channel=300):
        model = models.resnet101(pretrained=pretrained)
        super(DSDL, self).__init__(model, num_classes, alpha, in_channel=in_channel)
