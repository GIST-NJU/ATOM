...
class ML_GCN(GCNResnet):
    def __init__(self, num_classes, t, pretrained=False, adj_file=None, in_channel=300):
        model = models.resnet101(pretrained=pretrained)
        super(ML_GCN, self).__init__(model, num_classes, t=t, adj_file=adj_file, in_channel=in_channel)
