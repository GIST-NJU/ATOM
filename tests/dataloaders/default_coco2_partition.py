...
class COCO2014Classification2Partition(data.Dataset):
    def __init__(self, root, part: (int, int), transform=None, phase='train', followup=False, inp_name=None):
        self.root = root
        self.phase = phase
        self.part = part
    ...
    def get_anno(self):
        ...
        self.img_list = list(np.array_split(self.img_list, self.part[1])[self.part[0]])
